                            ...
                            <div class="tab-pane show active" id="input-types-preview">
                                <div class="row">
                                    <div class="col-lg-8 offset-lg-2">
                                        ...
                                        <form action="{{route('backend.services.translation.update',['service_id'=>$translation->service_id,'lang'=>$translation->locale])}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="description" placeholder="Enter a name" maxlength="255" >{{old('description',$translation)}}</textarea>
                                                @error('description')
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
