                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <a href="{{route('backend.products.create')}}" class="btn btn-success mb-2 text-end"><i class="mdi mdi-plus-circle me-2"></i>Add +</a>
                            ...
                            <div class="tab-pane show active" id="basic-datatable-preview">
                                <table id="datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(!isAllTranslated($query))
                                                <a href="{{ route('backend.products.edit', $query) }}" class="edit btn btn-primary btn-sm">Translate</a>
                                            @endif
                                            <a href="{{ route('backend.products.destroy', $query) }}" class="edit btn btn-danger btn-sm delete">Del</a>
                                        </td>
                                        <td>
                                            {!! $query->hasTranslation('ru') ? '<a href="'.route('backend.products.translation.edit', [$query, 'lang' => 'ru']).'" class="edit btn btn-secondary btn-sm">Rus</a>' : '' !!}
                                            {!! $query->hasTranslation('en') ? '<a href="'.route('backend.products.translation.edit', [$query, 'lang' => 'en']).'" class="edit btn btn-dark btn-sm">En</a>' : '' !!}
                                            {!! $query->hasTranslation('az') ? '<a href="'.route('backend.products.translation.edit', [$query, 'lang' => 'az']).'" class="edit btn btn-info btn-sm">Az</a>' : '' !!}
                                        </td>
...
@section('scripts')
    ...
    @include('backend.datatables.product')
@endsection
