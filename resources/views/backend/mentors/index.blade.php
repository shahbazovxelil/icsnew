                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <a href="{{route('backend.mentors.create')}}" class="btn btn-success mb-2 text-end"><i class="mdi mdi-plus-circle me-2"></i>Add mentor</a>
                            ...
                            <div class="tab-pane show active" id="basic-datatable-preview">
                                <table id="datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{asset($mentor->image)}}"  width="100px" height="100px">
                                        </td>
                                        <td>
                                            {{$mentor->name}}
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('backend.mentors.edit', $mentor) }}" class="edit btn btn-primary btn-sm ">Translate</a>
                                            <a href="{{ route('backend.mentors.destroy', $mentor) }}" class="edit btn btn-danger btn-sm delete ">Del</a>



                                        </td>
                                        <td>
                                            {!! $mentor->hasTranslation('ru') ? '<a href="'.route('backend.mentors.translation.edit', [$mentor, 'lang' => 'ru']).'" class="edit btn btn-secondary btn-sm">Rus</a>' : '' !!}
                                            {!! $mentor->hasTranslation('en') ? '<a href="'.route('backend.mentors.translation.edit', [$mentor, 'lang' => 'en']).'" class="edit btn btn-dark btn-sm">En</a>' : '' !!}
                                            {!! $mentor->hasTranslation('az') ? '<a href="'.route('backend.mentors.translation.edit', [$mentor, 'lang' => 'az']).'" class="edit btn btn-info btn-sm">Az</a>' : '' !!}
                                        </td>
...
@section('scripts')
    ...
    @include('backend.datatables.mentor')
