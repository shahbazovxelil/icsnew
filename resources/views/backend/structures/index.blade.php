                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <a href="{{route('backend.structures.create')}}" class="btn btn-success mb-2 text-end"><i class="mdi mdi-plus-circle me-2"></i>Add structure</a>
                                ...
                                <table id="datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('backend.structures.edit', $structure) }}" class="edit btn btn-primary btn-sm ">Translate</a>
                                            <a href="{{ route('backend.structures.destroy', $structure) }}" class="edit btn btn-danger btn-sm delete ">Del</a>



                                        </td>
                                        <td>
                                            {!! $structure->hasTranslation('ru') ? '<a href="'.route('backend.structures.translation.edit', [$structure, 'lang' => 'ru']).'" class="edit btn btn-secondary btn-sm">Rus</a>' : '' !!}
                                            {!! $structure->hasTranslation('en') ? '<a href="'.route('backend.structures.translation.edit', [$structure, 'lang' => 'en']).'" class="edit btn btn-dark btn-sm">En</a>' : '' !!}
                                            {!! $structure->hasTranslation('az') ? '<a href="'.route('backend.structures.translation.edit', [$structure, 'lang' => 'az']).'" class="edit btn btn-info btn-sm">Az</a>' : '' !!}
                                        </td>
...
@section('scripts')
    ...
    @include('backend.datatables.structure')
