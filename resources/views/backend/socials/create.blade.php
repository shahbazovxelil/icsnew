                            ...
                            <div class="tab-pane show active" id="input-types-preview">
                                <div class="row">
                                    <div class="col-lg-8 offset-lg-2">
                                        ...
                                        <form action="{{route('backend.socials.store')}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="mb-3">
                                                <label for="icon" class="form-label">Icon</label>
                                                <input type="file" value="{{old('icon')}}" class="custom-file-input @error('icon') is-invalid @enderror" name="icon" >
                                                @error('icon')
