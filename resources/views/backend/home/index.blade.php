...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="d-flex card-header justify-content-between align-items-center">
                    <h4 class="header-title">Revenueqqqqqqqqqqqqq</h4>
                    <div class="dropdown">
                        <a href="index.html#" class="dropdown-toggle arrow-none card-drop" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="mdi mdi-dots-vertical"></i>
                        </a>
...
@section('styles')
    ...
    <!-- Daterangepicker css -->
    <link href="backend/assets/vendor/daterangepicker/daterangepicker.css" rel="stylesheet" type="text/css">

    <!-- Vector Map css -->
    <link href="{{asset('backend/assets/vendor/jsvectormap/css/jsvectormap.min.css')}}" rel="stylesheet" type="text/css">

    <!-- Theme Config Js -->
    <script src="backend/assets/js/hyper-config.js"></script>

    <!-- App css -->
    <link href="backend/assets/css/app-saas.min.css" rel="stylesheet" type="text/css" id="app-style" />
...
@section('scripts')
    ...
    <!-- Daterangepicker js -->
    <script src="backend/assets/vendor/daterangepicker/moment.min.js"></script>
    <script src="backend/assets/vendor/daterangepicker/daterangepicker.js"></script>
