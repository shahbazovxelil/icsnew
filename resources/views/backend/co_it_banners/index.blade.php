                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-end">
                            <a href="{{route('backend.co_it_banners.create')}}" class="btn btn-success mb-2 text-end"><i class="mdi mdi-plus-circle me-2"></i>Add Banner</a>
                            ...
                            <div class="tab-pane show active" id="basic-datatable-preview">
                                <table id="datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {!! Str::limit($banner->long_description,40) !!}
                                        </td>
                                        <td>
                                            {{$banner->locale}}
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{  route('backend.co_it_banners.edit', $banner) }}" class="edit btn btn-primary btn-sm ">Translate</a>
                                            <a href="{{ route('backend.co_it_banners.destroy', $banner) }}" class="edit btn btn-danger btn-sm delete ">Del</a>


                                        </td>
                                        <td>
                                            {!! $banner->hasTranslation('ru') ? '<a href="'.route('backend.co_it_banners.translation.edit', [$banner, 'lang' => 'ru']).'" class="edit btn btn-secondary btn-sm">Rus</a>' : '' !!}
                                            {!! $banner->hasTranslation('en') ? '<a href="'.route('backend.co_it_banners.translation.edit', [$banner, 'lang' => 'en']).'" class="edit btn btn-dark btn-sm">En</a>' : '' !!}
                                            {!! $banner->hasTranslation('az') ? '<a href="'.route('backend.co_it_banners.translation.edit', [$banner, 'lang' => 'az']).'" class="edit btn btn-info btn-sm">Az</a>' : '' !!}
                                        </td>
...
@section('scripts')
    ...
    @include('backend.datatables.co_it_banner')
@endsection
