...
{{--                        @can('admins-create')--}}
                        <div class="d-flex justify-content-end">
                            <a href="{{route('backend.menus.create')}}" class="btn btn-success mb-2 text-end"><i class="mdi mdi-plus-circle me-2"></i>Menu əlavə et</a>
...
@section('scripts')
    ...
    @include('backend.datatables.menu')
