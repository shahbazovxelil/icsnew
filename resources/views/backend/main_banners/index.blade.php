                            ...
                            <div class="tab-pane show active" id="basic-datatable-preview">
                                <table id="datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{asset($main_banner?->image)}}"  width="100px" height="100px">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ $count ? route('backend.main_banners.edit', $main_banner) : '#' }}" class="edit btn btn-primary btn-sm {{ $count ? '' : 'disabled' }}">Translate</a>


                                        </td>
                                        <td>
                                            @if(!in_array('ru', $languages->toArray()))
                                            <a href="{{route('backend.main_banners.translation.edit', [$main_banner, 'lang' => 'ru'])}}" class="edit btn btn-secondary btn-sm">Rus</a>
                                            @endif

                                                @if(!in_array('en', $languages->toArray()))
                                                <a href="{{route('backend.main_banners.translation.edit', [$main_banner, 'lang' => 'en'])}}" class="edit btn btn-dark btn-sm">En</a>
                                                @endif
                                                @if(!in_array('az', $languages->toArray()))
                                                <a href="{{route('backend.main_banners.translation.edit', [$main_banner, 'lang' => 'az'])}}" class="edit btn btn-info btn-sm">Az</a>
                                                @endif
                                        </td>
                                    </tr>
                                    </tbody>
