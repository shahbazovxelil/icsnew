    ...
    <header class="header-style1">
        ...
        <div class="container">
            <div class="navbar-header navbar-header-custom row text-dark">
                ...
                <div class="col-lg-3">
                    <!-- start logo -->
                    <a href="index.html" class="navbar-brand logodefault"><img id="logo" src="{{asset('frontend/img/logos/logo-ch.png')}}" alt="logo"></a>
                    <!-- end logo -->
                </div>
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg navbar-light p-0">
                            ...
                            <ul class="navbar-nav" id="nav" style="display: none;">
                                ...
                                <li><a href="services.html#!">Pages</a>
                                    <ul>
                                        <li><a href="about.html">About Us</a></li>
                                        <li><a href="history.html">History</a></li>
                                        <li><a href="services.html#!">Team</a>
                                            <ul>
                                                <li><a href="our-team.html">Our Team</a></li>
                                                <li><a href="team-details.html">Team Details</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="services.html#!">Portfolio</a>
                                            <ul>
                                        ...
                                        <li><a href="services.html#!">Others</a>
                                            <ul>
                                ...
                                <li><a href="services.html#!">Elements</a>
                                ...
                                <li><a href="services.html#!">Blog</a>
                                    <ul>
                            ...
                            <div class="attr-nav align-items-lg-center ms-auto">
                                <ul>
                                    <li class="search"><a href="services.html#!"><i class="fas fa-search text-white"></i></a></li>
